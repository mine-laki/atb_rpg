...
export const EQUIPMENT_DATA: EquipmentData[] = [
  ...
  { id: 'sword_dragon',   name: '竜鱗の大剣', emoji: '🗡️', type: 'weapon', weaponType: 'sword',
    preferredRole: 'ATK', baseStats: { str: 80, hp: 200 }, effects: [{ type: 'damage_boost', value: 0.10 }], unlockStage: 3, shopPrice: 2800 },
  { id: 'staff_holy',     name: '聖光の杖',   emoji: '✨', type: 'weapon', weaponType: 'holy',
    preferredRole: 'HLR', baseStats: { mag: 90 }, effects: [{ type: 'heal_boost', value: 0.25 }, { type: 'buff_extend', value: 0.15 }], unlockStage: 3, shopPrice: 3000 },
  { id: 'staff_dark',     name: '闇の杖',     emoji: '🌑', type: 'weapon', weaponType: 'cursed',
    preferredRole: 'BLA', baseStats: { mag: 100 }, effects: [{ type: 'debuff_rate', value: 0.20 }, { type: 'magic_cost_reduce', value: 1 }], unlockStage: 4, shopPrice: 3500 },
  { id: 'bow_swift',      name: '疾風の弓',   emoji: '💨', type: 'weapon', weaponType: 'bow',
    baseStats: { str: 40, mag: 40 }, effects: [{ type: 'atb_speed', value: 0.25 }, { type: 'chain_boost', value: 0.08 }], unlockStage: 4, shopPrice: 4000 },
  { id: 'sword_masterwork', name: '極剣',     emoji: '⚔️', type: 'weapon', weaponType: 'sword',
    preferredRole: 'ATK', baseStats: { str: 120 }, effects: [{ type: 'atb_expand', value: 1 }, { type: 'damage_boost', value: 0.12 }], unlockStage: 5, shopPrice: 6000 },
  // ATB拡張 – 各武器種最強
  { id: 'staff_arcane',     name: '魔導の杖',     emoji: '🔯', type: 'weapon', weaponType: 'staff',
    preferredRole: 'BLA', baseStats: { mag: 120 }, effects: [{ type: 'atb_expand', value: 1 }, { type: 'magic_cost_reduce', value: 1 }], unlockStage: 5, shopPrice: 6500 },
  { id: 'bow_heaven',       name: '天空の弓',     emoji: '🏹', type: 'weapon', weaponType: 'bow',
    baseStats: { str: 60, mag: 60 }, effects: [{ type: 'atb_expand', value: 1 }, { type: 'chain_boost', value: 0.10 }], unlockStage: 5, shopPrice: 6500 },
  ...
  { id: 'holy_archangel',   name: '大天使の聖具', emoji: '👼', type: 'weapon', weaponType: 'holy',
    preferredRole: 'HLR', baseStats: { mag: 50 }, effects: [{ type: 'atb_expand', value: 1 }, { type: 'heal_boost', value: 0.35 }], unlockStage: 5, shopPrice: 6000 },
  ...
  { id: 'cursed_void',      name: '虚無の呪具',   emoji: '🌀', type: 'weapon', weaponType: 'cursed',
    preferredRole: 'JAM', baseStats: { mag: 40 }, effects: [{ type: 'atb_expand', value: 1 }, { type: 'debuff_rate', value: 0.40 }], unlockStage: 5, shopPrice: 6000 },
  // ボスドロップ限定レア武器 (shopPrice: 0)
  { id: 'relic_chaos',      name: 'カオスブレード', emoji: '⚡', type: 'weapon', weaponType: 'sword',
    preferredRole: 'ATK', baseStats: { str: 180 }, effects: [{ type: 'chain_boost', value: 0.30 }, { type: 'damage_boost', value: 0.20 }], unlockStage: 999, shopPrice: 0 },
  { id: 'relic_lich',       name: '死霊の魔杖',   emoji: '💀', type: 'weapon', weaponType: 'staff',
    preferredRole: 'BLA', baseStats: { mag: 180 }, effects: [{ type: 'magic_cost_reduce', value: 1 }, { type: 'chain_boost', value: 0.25 }], unlockStage: 999, shopPrice: 0 },
  ...
  { id: 'soul_blade',      name: '魂喰いの刃',   emoji: '🗡️', type: 'weapon', weaponType: 'sword',
    preferredRole: 'ATK', baseStats: { str: 60 }, effects: [{ type: 'damage_boost', value: 0.15 }], unlockStage: 999, shopPrice: 0 },
  { id: 'chaos_trident',   name: '混沌の三叉槍', emoji: '🔱', type: 'weapon', weaponType: 'sword',
    preferredRole: 'ATK', baseStats: { str: 40, mag: 40 }, effects: [{ type: 'damage_boost', value: 0.10 }, { type: 'chain_boost', value: 0.10 }], unlockStage: 999, shopPrice: 0 },
  { id: 'dark_grimoire',   name: '闇の秘典',     emoji: '📖', type: 'weapon', weaponType: 'staff',
    preferredRole: 'HLR', baseStats: { mag: 70 }, effects: [{ type: 'heal_boost', value: 0.15 }, { type: 'chain_boost', value: 0.05 }], unlockStage: 999, shopPrice: 0 },
  { id: 'starlight_codex', name: '星霊の聖典',   emoji: '🌟', type: 'weapon', weaponType: 'holy',
    preferredRole: 'HLR', baseStats: { mag: 50, hp: 300 }, effects: [{ type: 'heal_boost', value: 0.20 }, { type: 'auto_regen', value: 0.003 }], unlockStage: 999, shopPrice: 0 },
