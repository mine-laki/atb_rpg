...
export const MATERIALS: MaterialData[] = [
  { id: 'enhance_stone_normal', name: '強化石(通常)', emoji: '⚒️', description: '装備強化に使用' },
  { id: 'enhance_stone_rare',   name: '強化石(レア)', emoji: '💎', description: '高レベル装備強化に使用' },
  { id: 'crystal_atk',          name: 'ATKクリスタル', emoji: '⚔️', description: 'ATKロールレベルアップに使用' },
  { id: 'crystal_bla',          name: 'BLAクリスタル', emoji: '🔮', description: 'BLAロールレベルアップに使用' },
  { id: 'crystal_def',          name: 'DEFクリスタル', emoji: '🛡️', description: 'DEFロールレベルアップに使用' },
  { id: 'crystal_hlr',          name: 'HLRクリスタル', emoji: '💚', description: 'HLRロールレベルアップに使用' },
  { id: 'crystal_enh',          name: 'ENHクリスタル', emoji: '✨', description: 'ENHロールレベルアップに使用' },
  { id: 'crystal_jam',          name: 'JAMクリスタル', emoji: '💜', description: 'JAMロールレベルアップに使用' },
  { id: 'crystal_all',          name: '万能クリスタル', emoji: '🌈', description: 'どのロールにも使用可能' },
  { id: 'dragon_scale',         name: 'ドラゴンの鱗',  emoji: '🐉', description: '強化素材' },
  { id: 'dragon_fang',          name: 'ドラゴンの牙',  emoji: '🦷', description: '希少強化素材' },
];
